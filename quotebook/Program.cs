...
_board.AddQuote(
    new Quote(
        "Paul",
        "God hath not given us the spirit of fear; but of pwoer, and of love, and of a sound mind",
...
_board.AddQuote(
    new Quote("Alma","Give ye thanks daily.", new Source("Alma 34:38")));
_board.AddQuote(
    new Quote("Alma","Counsel with the Lord in all thy doings, and he will direct thee for good.",new Source("Alma 37:37")));
